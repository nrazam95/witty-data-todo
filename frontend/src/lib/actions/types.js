...
export const UPDATE_PUBLICITY_FAIL = "UPDATE_PUBLICITY_FAIL";
export const GET_PUBLIC_TODOS_SUCCESS = "GET_PUBLIC_TODOS_SUCCESS";
export const GET_PUBLIC_TODOS_FAIL = "GET_PUBLIC_TODOS_FAIL";
